...
import 'package:fan_page_app/helpers.dart';
import 'package:fan_page_app/model/user_ratings_model.dart';
...
class __ActionBarState extends State<_ActionBar> {
  ...
  void _showRatingAppDialog() {
    ...
    final _ratingDialog = RatingDialog(
      ...
      onSubmitted: (response) {
        if (otherMember != null) {
          _publishFirestoreDetails(otherMember.userId, response);
        }
      },
    );
  ...
  _publishFirestoreDetails(String? uid, RatingDialogResponse response) async {
    try {
      ...
      Fluttertoast.showToast(
          msg: "There was a problem submitting the rating, please try again.");
    }
  }
              ...
              child: InkWell(
                ...
                onTap: () {
                  ...
                  _determinePosition().then((value) {
                    channel.sendMessage(
                      Message(
                        text: 'This is my location: $value',
                      ),
                    );
                  }).catchError((err) {
